...
{ // main_function
	...
	//sprintf(fname_in1, "/media/Disk_YIN/AMPT-27GeV/27GeV-10M-2/*%d%02d1.root", job, min);
	sprintf(fname_in1, "/media/Disk_YIN/AMPT-27GeV/27GeV-4973/*%d%02d1.root", job, min);
		...
		//cout << "Centrality = " << Centrality << endl;
                ...
                for (int trki = 0; trki < NPTracks; trki++){
                        ...
                        if ((abs(PID) == 3122) || (abs(PID) == PID_2nd))
			...
			// cout << "PID = " << PID << endl;
				...
				//else if((PID == -3122) && (PID2 == -211)){
                                else if((PID == -3122) && (PID2 == (0-PID_2nd))){
